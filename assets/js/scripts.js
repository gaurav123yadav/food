...
-------------------------------------------*/
     ...
     * Add to Cart
     */
    $("a[data-cart]").click(function(){
        var product_id = $(this).attr('data-cart')
        var is_login = $(this).attr('data-authenticated')
        var csrftoken = $('[name=csrfmiddlewaretoken]').val()
        if(is_login){
            var cartText = $(this).find('span').html();
            ...
            $.post({
                ...
                success: function(res){
                    ...
                    $(that).find('span').html(cartText);
                },  
                error: function(error){
                    $(that).find('span').html(cartText);  
                    if(error.status == 200 && error.responseText == "True"){
     ...
     */
     $(".cart-plus-minus").click(function(){
        var product_id = $(this).find('input[type="text"]').attr('data-cart')
        var csrftoken = $('[name=csrfmiddlewaretoken]').val()
